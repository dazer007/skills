...
This is an **agent skills repository** containing skills for Codex and OpenClaw platforms. Skills are installed via `npx skills add` or by copying to `~/.Codex/skills/` (Codex) or `~/.openclaw/skills/` (OpenClaw).
